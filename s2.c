...
static int sb=4, rb=64, lb=NFUNC+100, cb=(NFUNC+200)*4, c, h, p, r, s, t, u;
...
/*  r  */ void f114() { u=st.b[p++]; if (btw(u,'A','Z')) { st.i[++s]=st.i[u+NFUNC]; } }
/*  s  */ void f115() { u=st.b[p++]; if (btw(u,'A','Z')) { st.i[u+NFUNC]=st.i[s--]; } }
