...
f98,f99,f100,f101,f102,X,X,f105,X,X,f108,f109,X,X,X,f113,f114,f115,f116,X,X,X,f120,X,X,f123,X,f125,X };
...
void main(int argc, char *argv[]) {
    s=sb-1; h=cb; for (int i=0; i<(SZ/4); i++) { st.i[i]=0; }
    for (int i=1; i < argc; ++i) { y=argv[i]; t=atoi(y); if (y[0]=='0' && y[1]==0) y=0; st.i[ro+'0'+i]=t?t:(int)y; }
